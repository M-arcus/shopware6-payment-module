        ...
        (() => {
            ...
            class i {
                ...
                static hasAttribute(e, t) {
                    ...
                    return (
                        'function' == typeof e.hasAttribute && e.hasAttribute(t)
                    );
                }
            ...
            class s {
                publish(e) {
                    let t =
                        ...
                        r =
                            ...
                            void 0 !== arguments[2] &&
                            arguments[2],
                        n = new CustomEvent(e, { detail: t, cancelable: r });
                ...
                subscribe(e, t) {
                    ...
                    return (
                        this.el.addEventListener(i[0], s),
                        this.listeners.push({
                            splitEventName: i,
                            opts: r,
                            cb: s,
            ...
            class o {
                ...
                _mergeOptions(e) {
                    let r = n.toDashCase(this._pluginName),
                        s = i.getDataAttribute(
                            this.el,
            ...
            class a {
                get(e, t) {
                    let r =
                            arguments.length > 2 && void 0 !== arguments[2]
                                ? arguments[2]
                                : 'application/json',
                        n = this._createPreparedRequest('GET', e, r);
                    return this._sendRequest(n, null, t);
                }
                post(e, t, r) {
                    let n =
                        arguments.length > 3 && void 0 !== arguments[3]
                            ? arguments[3]
                            : 'application/json';
                    n = this._getContentType(t, n);
                    let i = this._createPreparedRequest('POST', e, n);
                ...
                delete(e, t, r) {
                    let n =
                        arguments.length > 3 && void 0 !== arguments[3]
                            ...
                            : 'application/json';
                    n = this._getContentType(t, n);
                    let i = this._createPreparedRequest('DELETE', e, n);
                    return this._sendRequest(i, t, r);
                }
                patch(e, t, r) {
                    let n =
                        arguments.length > 3 && void 0 !== arguments[3]
                            ...
                            : 'application/json';
                    n = this._getContentType(t, n);
                    let i = this._createPreparedRequest('PATCH', e, n);
                    return this._sendRequest(i, t, r);
                }
                abort() {
                ...
                constructor() {
                    ((this._request = null),
                        (this._errorHandlingInternal = !1));
                }
            }
            class l extends o {
                init() {
                    (this._insertWidget(), this._registerEvents());
                }
                _registerEvents() {
                        ...
                        BillieCheckoutWidget.mount({
                            ...
                            .then((e) => {
                                let t = new a(
                                    ...
                                    r = '/billie-payment/update-addresses',
                                    n = window.location.href.match(
                                        /account\/order\/edit\/([A-Za-z0-9]+)/
                                    );
                                (n && 2 === n.length && (r += '/' + n[1]),
                                    'csrf' in window &&
                                        window.csrf.enabled &&
                                        'twig' === window.csrf.mode &&
                                        (e._csrf_token =
                                            this.options.csrfToken),
                                    t.post(r, JSON.stringify(e), (e) => {
                                        (this._setAddressConfirmed(!0),
                                            (this.el.value =
                                                this.options.checkoutSessionId),
                                            this.el.form.submit());
                                    }));
                            })
                            .catch((t) => {
                ...
                _setAddressConfirmed(e) {
                    this.el.form.dataset.billieConfirmed = parseInt(e);
                }
                _isAddressConfirmed() {
                    return 1 === parseInt(this.el.form.dataset.billieConfirmed);
                }
            }
            l.options = {
                src: null,
            ...
            let c = window.PluginManager;
            'BillieCheckout' in c.getPluginList() ||
                c.register(
                    'BillieCheckout',
                    l,
                    '[data-billie-checkout="true"]'
                );
        })());
})();
